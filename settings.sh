...
PACKAGES=(
	...
	# added
	fluidsynth glu libjpeg-turbo openssl-1.1 timidity++ bzip2 zlib qt6-base qt6-multimedia qt6-tools wxwidgets-gtk3 freeimage sfml ftgl webkit2gtk
)

# If you want to install AUR packages, specify them in this variable
AUR_PACKAGES=(faugus-launcher-git gtk2 doomseeker sdl)
